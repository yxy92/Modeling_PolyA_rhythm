...
X1=scatter(PAR.Ptrsc,PAR.Pss,10,color1,'filled');
pbaspect([1 1 1])
xlim([0 24])
ylim([0 24]);
xticks([0 12 24]);
yticks([0 12 24]);
set(gca,'LineWidth',2,'TickLength',[0.1 0.1]);
ax.FontSize = 20;

ax=subplot(2,2,2);
ax.Position = [0.6 0.68 0.28 0.28];
X4=scatter(PAR.Pdgrd,PAR.Pss,10,color2,'filled');
pbaspect([1 1 1])
xlim([0 24])
ylim([0 24]);
xticks([0 12 24]);
...
X2=scatter(PAR.PdeA,PAR.Pss,10,color3,'filled');
pbaspect([1 1 1])
xlim([0 24])
ylim([0 24]);
xticks([0 12 24]);
...
%save this figure
saveas(gcf,"PssPhaseScatter.png");