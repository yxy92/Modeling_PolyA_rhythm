...
for trial=1:trial_num 
    ...
    % change order of columns such that Trsc, Dgrd, DeA
    single_T = single_T([1 2 6 7 8 3 4 5],:);
    ...
    % change order of columns such that Trsc, Dgrd, DeA
    total_T = total_T([1 2 6 7 8 3 4 5],:); 
    
    Total_Sobol(:,:,trial) = total_T;
end

%% plotting stuff   
inputVariable = {'Atrsc','Ptrsc','Kdgrd','Adgrd','Pdgrd','KdeA','AdeA','PdeA'};
