...
output_dir = 'D:\CircadianRhythmicity\2019Fall\Sobol_Indices_Calculation_Version_for_Manuscript_V4\A1B1D1\Wiki_Sampling\Manuscript_Figure\Supplemental_Figure\';
...
for i=1:length(outputQuantity)
    ...
    single_tmp = single_tmp(:,[1 2 6 7 8 3 4 5]);
    total_tmp = total_tmp(:,[1 2 6 7 8 3 4 5]);
