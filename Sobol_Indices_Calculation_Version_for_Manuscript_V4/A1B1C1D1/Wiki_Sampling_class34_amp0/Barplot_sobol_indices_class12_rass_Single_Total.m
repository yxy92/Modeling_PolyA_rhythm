% Barplot_sobol_indices_class34_rass_Single_Total.m
% --------------------------------------------
...
input_dir = 'D:\CircadianRhythmicity\2019Fall\Sobol_Indices_Calculation_Version_for_Manuscript_V4\A1B1C1D1\Wiki_Sampling_class34_amp0\Table\';
output_dir = 'D:\CircadianRhythmicity\2019Fall\Sobol_Indices_Calculation_Version_for_Manuscript_V4\A1B1C1D1\Wiki_Sampling_class34_amp0\';
...
%% plotting stuff   
inputVariable = {'KdeA','AdeA','PdeA','Kdgrd','Adgrd','Pdgrd'};
...
% Trsc, Dgrd, DeA, polyA
Single_Sobol_mean = Single_Sobol_mean([9 10 11 3 4 5 6 7 8],:);
Total_Sobol_mean = Total_Sobol_mean([9 10 11 3 4 5 6 7 8],:);



Single_Sobol_sd = Single_Sobol_sd([9 10 11 3 4 5 6 7 8],:);
Total_Sobol_sd = Total_Sobol_sd([9 10 11 3 4 5 6 7 8],:);
