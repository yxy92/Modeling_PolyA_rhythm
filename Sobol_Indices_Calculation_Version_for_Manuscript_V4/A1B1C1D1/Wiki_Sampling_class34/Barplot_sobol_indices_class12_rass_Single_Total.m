...
output_dir = 'D:\CircadianRhythmicity\2019Fall\Sobol_Indices_Calculation_Version_for_Manuscript_V4\A1B1C1D1\Wiki_Sampling_class34\';
...
for j=1:Input_Number
    text(j-0.2,Sobol_mean(j,1),'S','HorizontalAlignment','center','VerticalAlignment','bottom'); % Single
    text(j+0.2,Sobol_mean(j,2),'T','HorizontalAlignment','center','VerticalAlignment','bottom'); % Total
end
% customize axes
ax = gca;
