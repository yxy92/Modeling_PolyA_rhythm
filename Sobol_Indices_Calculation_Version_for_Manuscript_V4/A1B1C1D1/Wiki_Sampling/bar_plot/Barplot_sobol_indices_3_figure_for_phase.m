...
for i=3:3:9
    ...
    saveas(gcf,strcat(output_dir,'Single_Sobol',outputQuantity{i},'.png'));
    ...
    saveas(gcf,strcat(output_dir,'Total_Sobol',outputQuantity{i},'.png'));
    %saveas(gcf,strcat(output_dir,'Single_Total_Sobol',outputQuantity{i},'.svg'));
